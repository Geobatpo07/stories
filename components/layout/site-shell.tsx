    ...
    <>
      ...
      <header className="site-header">
        <div className="shell header-inner">
          <Link className="wordmark" href="/" aria-label="Stories laboratory home">
            <span className="wordmark-mark" aria-hidden="true">
              S
            </span>
            <span>
              Stories <small>Research Laboratory</small>
            </span>
          </Link>
      ...
      <footer className="site-footer">
        <div className="shell footer-inner">
          <p>Stories is the public memory of an evolving research practice.</p>
          <p>
